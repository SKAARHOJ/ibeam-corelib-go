...
const (
	...
	Command_Increment Command = 1
	Command_Decrement Command = 2
)
...
const (
	...
	ControlStyle_Incremental           ControlStyle = 2 // Accept only Command::Increment and Command::Decrement
	ControlStyle_NoControl             ControlStyle = 3 // Accept no control, display only
	ControlStyle_Oneshot               ControlStyle = 4 // Accept only Command::Trigger
	ControlStyle_ControlledIncremental ControlStyle = 5 // Simulate Normal by using Incremental under the hood
)
...
type CoreInfo struct {
	...
	IbeamVersion string `protobuf:"bytes,1,opt,name=ibeamVersion,proto3" json:"ibeamVersion,omitempty"` // Implemented version of the IBeam Protocol (better
	// String than int for Versions like 1.0.2b)
	CoreVersion string `protobuf:"bytes,2,opt,name=coreVersion,proto3" json:"coreVersion,omitempty"` // Implemented version of the IBeam Core
...
type ParameterValue struct {
	...
	Available      bool   `protobuf:"varint,2,opt,name=available,proto3" json:"available,omitempty"`           // Ignored in set request
	IsAssumedState bool   `protobuf:"varint,3,opt,name=isAssumedState,proto3" json:"isAssumedState,omitempty"` // Ignored in set request
	...
	MetaValues []*ParameterMetaValue  `protobuf:"bytes,20,rep,name=metaValues,proto3" json:"metaValues,omitempty"`
}
...
func (x *ParameterValue) GetInstanceID() uint32 {
	if x != nil {
		return x.InstanceID
	}
	return 0
...
func (x *ParameterValue) GetMetaValues() []*ParameterMetaValue {
	if x != nil {
		return x.MetaValues
	}
	return nil
...
type ParameterValue_Floating struct {
	Floating float32 `protobuf:"fixed32,5,opt,name=floating,proto3,oneof"`
}

type ParameterValue_CurrentOption struct {
	CurrentOption uint32 `protobuf:"varint,6,opt,name=currentOption,proto3,oneof"`
}
...
type ParameterValue_Cmd struct {
	Cmd Command `protobuf:"varint,8,opt,name=cmd,proto3,enum=ibeam_core.Command,oneof"`
}

type ParameterValue_Binary struct {
	Binary bool `protobuf:"varint,9,opt,name=binary,proto3,oneof"`
}

type ParameterValue_OptionList struct {
	OptionList *OptionList `protobuf:"bytes,10,opt,name=optionList,proto3,oneof"`
}
...
type ParameterDetail struct {
	...
	Name                string            `protobuf:"bytes,2,opt,name=name,proto3" json:"name,omitempty"`
	Instances           uint32            `protobuf:"varint,3,opt,name=instances,proto3" json:"instances,omitempty"` // this can give parameters a second dimension of
	...
	IsSpeedValue        bool              `protobuf:"varint,8,opt,name=isSpeedValue,proto3" json:"isSpeedValue,omitempty"` // Specifys if this parameter can be controled via a
	...
	ControlDelayMs      uint32            `protobuf:"varint,11,opt,name=controlDelayMs,proto3" json:"controlDelayMs,omitempty"`       // minimum delay between sent commands
	QuarantineDelayMs   uint32            `protobuf:"varint,12,opt,name=quarantineDelayMs,proto3" json:"quarantineDelayMs,omitempty"` // time to wait after a set before sending new
	RetryCount          uint32            `protobuf:"varint,13,opt,name=retryCount,proto3" json:"retryCount,omitempty"`               // how often to retry a set if target != current
	...
	Minimum             float32           `protobuf:"fixed32,16,opt,name=minimum,proto3" json:"minimum,omitempty"`     // optional, proto3 makes all values optional
	Maximum             float32           `protobuf:"fixed32,17,opt,name=maximum,proto3" json:"maximum,omitempty"`     // optional
	OptionList          *OptionList       `protobuf:"bytes,18,opt,name=optionList,proto3" json:"optionList,omitempty"` // optional
	...
	MetaDescription []*ParameterMetaDescription `protobuf:"bytes,21,rep,name=metaDescription,proto3" json:"metaDescription,omitempty"`
}
...
func (x *ParameterDetail) GetInstances() uint32 {
	if x != nil {
		return x.Instances
	}
	return 0
...
func (x *ParameterDetail) GetMetaDescription() []*ParameterMetaDescription {
	if x != nil {
...
func (x *ParameterMetaValue) GetKey() string {
	if x != nil {
		return x.Key
	}
	return ""
...
type ParameterMetaValue_Binary struct {
	Binary bool `protobuf:"varint,3,opt,name=binary,proto3,oneof"`
}
...
type ParameterMetaDescription struct {
	...
	Key      string            `protobuf:"bytes,1,opt,name=key,proto3" json:"key,omitempty"` // In case of meta the key is the id
	MetaType ParameterMetaType `protobuf:"varint,2,opt,name=metaType,proto3,enum=ibeam_core.ParameterMetaType" json:"metaType,omitempty"`
}
...
func (x *ParameterMetaDescription) GetKey() string {
	if x != nil {
		return x.Key
	}
	return ""
...
var file_ibeam_core_proto_rawDesc = []byte{
	...
	0x72, 0x52, 0x0a, 0x70, 0x61, 0x72, 0x61, 0x6d, 0x65, 0x74, 0x65, 0x72, 0x73, 0x22, 0xb2, 0x03,
	...
	0x64, 0x53, 0x74, 0x61, 0x74, 0x65, 0x12, 0x1a, 0x0a, 0x07, 0x69, 0x6e, 0x74, 0x65, 0x67, 0x65,
	0x72, 0x18, 0x04, 0x20, 0x01, 0x28, 0x05, 0x48, 0x00, 0x52, 0x07, 0x69, 0x6e, 0x74, 0x65, 0x67,
	0x65, 0x72, 0x12, 0x1c, 0x0a, 0x08, 0x66, 0x6c, 0x6f, 0x61, 0x74, 0x69, 0x6e, 0x67, 0x18, 0x05,
	...
	0x6e, 0x18, 0x06, 0x20, 0x01, 0x28, 0x0d, 0x48, 0x00, 0x52, 0x0d, 0x63, 0x75, 0x72, 0x72, 0x65,
	0x6e, 0x74, 0x4f, 0x70, 0x74, 0x69, 0x6f, 0x6e, 0x12, 0x12, 0x0a, 0x03, 0x73, 0x74, 0x72, 0x18,
	0x07, 0x20, 0x01, 0x28, 0x09, 0x48, 0x00, 0x52, 0x03, 0x73, 0x74, 0x72, 0x12, 0x27, 0x0a, 0x03,
	0x63, 0x6d, 0x64, 0x18, 0x08, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x13, 0x2e, 0x69, 0x62, 0x65, 0x61,
	...
	0x09, 0x20, 0x01, 0x28, 0x08, 0x48, 0x00, 0x52, 0x06, 0x62, 0x69, 0x6e, 0x61, 0x72, 0x79, 0x12,
	0x38, 0x0a, 0x0a, 0x6f, 0x70, 0x74, 0x69, 0x6f, 0x6e, 0x4c, 0x69, 0x73, 0x74, 0x18, 0x0a, 0x20,
	...
	0x70, 0x74, 0x69, 0x6f, 0x6e, 0x4c, 0x69, 0x73, 0x74, 0x12, 0x3e, 0x0a, 0x0a, 0x6d, 0x65, 0x74,
	0x61, 0x56, 0x61, 0x6c, 0x75, 0x65, 0x73, 0x18, 0x14, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x1e, 0x2e,
	0x69, 0x62, 0x65, 0x61, 0x6d, 0x5f, 0x63, 0x6f, 0x72, 0x65, 0x2e, 0x50, 0x61, 0x72, 0x61, 0x6d,
	0x65, 0x74, 0x65, 0x72, 0x4d, 0x65, 0x74, 0x61, 0x56, 0x61, 0x6c, 0x75, 0x65, 0x52, 0x0a, 0x6d,
	0x65, 0x74, 0x61, 0x56, 0x61, 0x6c, 0x75, 0x65, 0x73, 0x42, 0x07, 0x0a, 0x05, 0x76, 0x61, 0x6c,
	...
	0x03, 0x69, 0x64, 0x73, 0x22, 0xbe, 0x07, 0x0a, 0x0f, 0x50, 0x61, 0x72, 0x61, 0x6d, 0x65, 0x74,
	...
	0x73, 0x74, 0x61, 0x6e, 0x63, 0x65, 0x73, 0x18, 0x03, 0x20, 0x01, 0x28, 0x0d, 0x52, 0x09, 0x69,
	0x6e, 0x73, 0x74, 0x61, 0x6e, 0x63, 0x65, 0x73, 0x12, 0x14, 0x0a, 0x05, 0x6c, 0x61, 0x62, 0x65,
	...
	,
	...
	,
	...
	,
	...
	,
	...
	0x6f, 0x46, 0x65, 0x65, 0x64, 0x62, 0x61, 0x63, 0x6b, 0x10, 0x03, 0x2a, 0x71, 0x0a, 0x0c, 0x43,
	0x6f, 0x6e, 0x74, 0x72, 0x6f, 0x6c, 0x53, 0x74, 0x79, 0x6c, 0x65, 0x12, 0x0d, 0x0a, 0x09, 0x55,
	0x6e, 0x64, 0x65, 0x66, 0x69, 0x6e, 0x65, 0x64, 0x10, 0x00, 0x12, 0x0a, 0x0a, 0x06, 0x4e, 0x6f,
	...
	,
	...
	0x6e, 0x42, 0x17, 0x5a, 0x0c, 0x2e, 0x3b, 0x69, 0x62, 0x65, 0x61, 0x6d, 0x5f, 0x63, 0x6f, 0x72,
	0x65, 0xc2, 0xb8, 0x02, 0x05, 0x30, 0x2e, 0x31, 0x2e, 0x31, 0x62, 0x06, 0x70, 0x72, 0x6f, 0x74,
	0x6f, 0x33,
}
...
var file_ibeam_core_proto_msgTypes = make([]protoimpl.MessageInfo, 21)
var file_ibeam_core_proto_goTypes = []interface{}{
	...
	(*ParameterMetaValue)(nil),       // 27: ibeam_core.ParameterMetaValue
	(*ParameterMetaDescription)(nil), // 28: ibeam_core.ParameterMetaDescription
	(*ParameterOption)(nil),          // 29: ibeam_core.ParameterOption
	(*descriptor.FileOptions)(nil),   // 30: google.protobuf.FileOptions
}
var file_ibeam_core_proto_depIdxs = []int32{
	...
	27, // 10: ibeam_core.ParameterValue.metaValues:type_name -> ibeam_core.ParameterMetaValue
	...
	7,  // 14: ibeam_core.ParameterDetail.genericType:type_name -> ibeam_core.GenericType
	5,  // 15: ibeam_core.ParameterDetail.controlStyle:type_name -> ibeam_core.ControlStyle
	4,  // 16: ibeam_core.ParameterDetail.feedbackStyle:type_name -> ibeam_core.FeedbackStyle
	3,  // 17: ibeam_core.ParameterDetail.valueType:type_name -> ibeam_core.ValueType
	6,  // 18: ibeam_core.ParameterDetail.displayStyle:type_name -> ibeam_core.DisplayStyle
	22, // 19: ibeam_core.ParameterDetail.optionList:type_name -> ibeam_core.OptionList
	21, // 20: ibeam_core.ParameterDetail.defaultValue:type_name -> ibeam_core.ParameterValue
	28, // 21: ibeam_core.ParameterDetail.metaDescription:type_name -> ibeam_core.ParameterMetaDescription
	25, // 22: ibeam_core.ParameterDetails.details:type_name -> ibeam_core.ParameterDetail
	1,  // 23: ibeam_core.ParameterMetaDescription.metaType:type_name -> ibeam_core.ParameterMetaType
	30, // 24: ibeam_core.ibeam_version:extendee -> google.protobuf.FileOptions
	9,  // 25: ibeam_core.IbeamCore.GetCoreInfo:input_type -> ibeam_core.Empty
	11, // 26: ibeam_core.IbeamCore.GetDeviceInfo:input_type -> ibeam_core.DeviceIDs
	14, // 27: ibeam_core.IbeamCore.GetModelInfo:input_type -> ibeam_core.ModelIDs
	18, // 28: ibeam_core.IbeamCore.Get:input_type -> ibeam_core.DeviceParameterIDs
	24, // 29: ibeam_core.IbeamCore.GetParameterDetails:input_type -> ibeam_core.ModelParameterIDs
	20, // 30: ibeam_core.IbeamCore.Set:input_type -> ibeam_core.Parameters
	18, // 31: ibeam_core.IbeamCore.Subscribe:input_type -> ibeam_core.DeviceParameterIDs
	10, // 32: ibeam_core.IbeamCore.GetCoreInfo:output_type -> ibeam_core.CoreInfo
	13, // 33: ibeam_core.IbeamCore.GetDeviceInfo:output_type -> ibeam_core.DeviceInfos
	16, // 34: ibeam_core.IbeamCore.GetModelInfo:output_type -> ibeam_core.ModelInfos
	20, // 35: ibeam_core.IbeamCore.Get:output_type -> ibeam_core.Parameters
	26, // 36: ibeam_core.IbeamCore.GetParameterDetails:output_type -> ibeam_core.ParameterDetails
	9,  // 37: ibeam_core.IbeamCore.Set:output_type -> ibeam_core.Empty
	19, // 38: ibeam_core.IbeamCore.Subscribe:output_type -> ibeam_core.Parameter
